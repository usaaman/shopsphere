  ...
  return (
    <div className="max-w-md mx-auto my-16 px-6">
      ...
      >
        ...
        <p className="text-xs text-gray-500 mb-6 font-light">Enter your email and credentials to manage your account details.</p>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            <div className="flex justify-between items-center">
              ...
              <Link to="/forgot-password" className="text-[10px] font-bold text-secondary hover:underline uppercase tracking-wide">
                Forgot?
              </Link>
            </div>
            <input
